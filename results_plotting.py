...
nz1,h1,errh1,bvt1=np.loadtxt('mean_results_sigh0p00'+str(int(sig1*1000))+'_'+str(alg)+'_GCV'+gcv+'.dat', unpack='True')
nz2,h2,errh2,bvt2=np.loadtxt('mean_results_sigh0p0'+str(int(sig2*100))+'_'+str(alg)+'_GCV'+gcv+'.dat', unpack='True')
nz3,h3,errh3,bvt3=np.loadtxt('mean_results_sigh0p0'+str(int(sig3*100))+'_'+str(alg)+'_GCV'+gcv+'.dat', unpack='True')
nz4,h4,errh4,bvt4=np.loadtxt('mean_results_sigh0p0'+str(int(sig4*100))+'_'+str(alg)+'_GCV'+gcv+'.dat', unpack='True')
nz5,h5,errh5,bvt5=np.loadtxt('mean_results_sigh0p0'+str(int(sig5*100))+'_'+str(alg)+'_GCV'+gcv+'.dat', unpack='True')
...
if par=='bvt':
    ...
    plt.plot(nz1, mse1, '->', color='#228B22')
    plt.plot(nz2, mse2, '-o', color='black')
    plt.plot(nz3, mse3, '-s', color='red')
    plt.plot(nz4, mse4, '-*', color='blue')
    plt.plot(nz5, mse5, '-v', color='magenta')
...
fig_name = par+'_estimates_'+alg+'_GCV'+gcv
